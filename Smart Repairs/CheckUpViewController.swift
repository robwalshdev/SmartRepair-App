...
class CheckUpViewController: UIViewController {
    ...
    @IBOutlet var batteryLevel: UIProgressView!
    @IBOutlet var storageLevel: UIProgressView!
    ...
    override func viewDidLoad() {
        ...
        batteryLevel.setProgress(battery, animated: true)
        
        //Storage Space
        let freeSpace = Float(UIDevice.current.systemFreeSize!)
        let totalSpace = Float(UIDevice.current.systemSize!)
        let storage = freeSpace/totalSpace
        storageLevel.setProgress(storage, animated: true)
